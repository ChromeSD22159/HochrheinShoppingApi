...
import de.frederikkohler.model.externalApi.ExchangeRateResponse
import de.frederikkohler.model.externalApi.GermanHolidaysResponse
import de.frederikkohler.model.externalApi.WeatherResponse
...
fun Application.configureRouting(
    ...
    currencyExchangeRateService: CurrencyExchangeRateService =get()
) {
    ...
    routing {
        ...
        get("/api/get-data") {
            ...
            currencyExchangeRateService.addCurrencyRate(
                CurrencyExchangeRate(
                    sourceCurrency = exchangeRate.result.source,
                    targetCurrency = exchangeRate.result.target,
                    exchangeRate = exchangeRate.result.value,
                    updated_at = exchangeRate.result.updated
                )
            )
